...
|---|---|---|---|---|
| **1.2** | Actualizar gradientes heatmaps | 07/01/2025 | colorUtils.ts | IA Agent |

### **🔴 CRÍTICAS PENDIENTES**
| ID | Tarea | Prioridad | Estimación | Bloqueadores |
|---|---|---|---|---|
| **E1** | Solucionar gap en marcos | ALTA | 2h | Ninguno |
| **E2** | Corregir iconos dispares | ALTA | 1h | Ninguno |
| **E3.1** | Especificar niveles pérdida | ALTA | 1h | Ninguno |
| **E3.2** | Recuadro gris distribución | ALTA | 30min | Ninguno |
| **E3.3** | Colores verde/rojo volumen | ALTA | 30min | Ninguno |
| **E3.4** | Restaurar 4 insights | ALTA | 1h | Ninguno |
| **E4.1** | Actualizar prompt IA | ALTA | 2h | Ninguno |
...
### **Frontend (UI/UX)**
- **CryptoTable.tsx**: ✅ Completado (alineación)
