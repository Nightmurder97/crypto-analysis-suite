...
import styles from './ClassicHeatmapDisplay.module.css';
...
const ClassicLegend: React.FC<{ metric: HeatmapMetric }> = ({ metric }) => {
  ...
  return (
    <div className="flex items-center justify-center space-x-4 my-3 text-xs text-slate-400">
      {isPercentage ? (
        <>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendPositive}`}></div> Strong Positive</div>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendNeutral}`}></div> Neutral</div>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendNegative}`}></div> Strong Negative</div>
        </>
      ) : (
         <>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendHigh}`}></div> High Value</div>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendMid}`}></div> Mid Value</div>
          <div className="flex items-center"><div className={`${styles.legendIcon} ${styles.legendLow}`}></div> Low Value</div>
        </>
      )}
    </div>
  );
